    ...
    def mark_attendance(self,i,r,n):
        with open("attendance.csv","r+",newline="\n") as f:
            ...
            if((i not in name_list)) and ((r not in name_list)) and ((n not in name_list)):
                ...
                data = f"{i},{r},{n},{dtString},{d1},Present\n"
                f.write(data)
    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for (x,y,w,h) in featuers:
                ...
                if confidence > 77:
                    cv2.putText(img,f"Student_ID:{i}",(x,y-55),cv2.FONT_HERSHEY_COMPLEX,0.8,(64,15,223),2)
                    cv2.putText(img,f"Name:{n}",(x,y-30),cv2.FONT_HERSHEY_COMPLEX,0.8,(64,15,223),2)
                    cv2.putText(img,f"Roll-No:{r}",(x,y-5),cv2.FONT_HERSHEY_COMPLEX,0.8,(64,15,223),2)
