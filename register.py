...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\Bhumika\Documents\Python_Test_Projects\Images_GUI\bgReg.jpg")
        ...
        # img1=Image.open(r"C:\Users\Bhumika\Documents\Python_Test_Projects\Images_GUI\reg1.png")
        ...
        validate_fname=root.register(checkfname) #callback
        self.txtuser.config(validate="key",validatecommand= (validate_fname,"%P")) #bind
        ...
        validate_lname=root.register(checklname) #callback
        self.txtuser.config(validate="key",validatecommand= (validate_lname,"%P")) #bind
