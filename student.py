...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","BCOM","BBA","BCA")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","Commerce","Business Adminstration","Computer Application",)
        cou_combo.current(0)
        ...
        year_combo["values"]=("Select Year","2020-23","2021-24","2022-25","2023-26")
